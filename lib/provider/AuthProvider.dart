  ...
  void login({required Map creds}) async {
    ...
    try {
      Dio.Response response = await dio().post(
          Constants.BASE_URL + Constants.LOGIN_ROUTE, data: creds);
  ...
  Future<void> registerUser({
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        // Registration failed
        print('Registration failed: ${Constants.BASE_URL} ${Constants
            .REGISTER_ROUTE} ${response.toString()} ${response.body}');
